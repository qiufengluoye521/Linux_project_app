...
{
    unsigned char * dots = (unsigned char *)&fontdata_8x16[16*c];
    unsigned int i,j;

    printf("x y c is %d,%d,%c\n",x,y,c);
...
int main(int argc, char ** argv)
{
    ...
    /* fbmem Ö¸ÏòµÄµØÖ·£¬¾ÍÊÇÐ´LCDÆÁÄ»µÄµØÖ·£¬¶ÔfbmemµØÖ·¶ÔÓ¦Ð´Öµ  ¾ÍÊÇÐ´LCD */
